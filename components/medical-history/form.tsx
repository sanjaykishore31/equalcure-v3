  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <RadioGroup
          onValueChange={(value) => form.setValue('exposureSource', value)}
          className="space-y-2"
        >
          <div className="flex items-center space-x-2">
            <RadioGroupItem value="blood_transfusion" id="exposure-blood" />
            <Label htmlFor="exposure-blood">Blood transfusion</Label>
          </div>
          <div className="flex items-center space-x-2">
