...
import { Stethoscope, Building2, Users, HandHelp, ArrowLeft, HeartPulse, LineChart, Microscope, Award, Target, MapPin, ShieldCheck } from 'lucide-react';
          ...
          <section className="container mx-auto px-4 py-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card className="p-8 hover:shadow-lg transition-shadow bg-gradient-to-br from-slate-800 via-slate-700 to-slate-600 text-white">
                <div className="flex items-start mb-4">
                  <div className="bg-white/10 p-3 rounded-full mr-4">
                    <HandHelp className="h-6 w-6 text-white" />
                  </div>
                  <div>
